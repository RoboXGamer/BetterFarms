...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
  ...
  //  Create Recipes here
    CropFarmRecipeBuilder.create(RecipeCategory.MISC, ItemTags.AXES,Ingredient.of(Items.SPRUCE_SAPLING),Ingredient.of(Items.DIRT),new ChanceResult(new ItemStack(Items.SPRUCE_LOG),1f))
        .addOutput(new ChanceResult(new ItemStack(Items.SPRUCE_SAPLING),0.5f))
        .save(recipeOutput);
  }
